...
scm_summary    <- readr::read_csv(file.path(output_root, "am_2017_01_v2_scm_summary.csv"),       show_col_types = FALSE)
...
preferred_specs <- tibble::tribble(
  ...
  "formal_hiring_balance_sa_per_100k_wap",                    "monthly",          "sa",           "labor_market",   "Formal hiring SA",
  "formal_hiring_balance_construction_sa_per_100k_wap",       "monthly",          "sa",           "labor_market",   "Construction SA",
  "retail_volume_index_sa",                                   "monthly",          "sa",           "consumption",    "Retail SA",
  "services_volume_index_sa",                                 "monthly",          "sa",           "consumption",    "Services SA",
  "state_tax_revenue_real_pc_sa",                             "bimonthly_fiscal", "sa",           "public_sector",  "Own tax revenue SA",
  "icms_revenue_real_pc_sa",                                  "bimonthly_fiscal", "sa",           "public_sector",  "ICMS SA",
  "public_investment_liquidated_real_pc_sa",                  "bimonthly_fiscal", "sa",           "public_sector",  "Public investment SA",
  "liquidated_expenditure_total_real_pc_sa",                  "bimonthly_fiscal", "sa",           "public_sector",  "Total expenditure SA"
)
