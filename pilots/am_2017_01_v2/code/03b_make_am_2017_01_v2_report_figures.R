...
covariates_raw    <- readr::read_csv(file.path(data_dir, "am_2017_01_v2_covariates.csv"),             show_col_types = FALSE)
monthly_panel     <- readr::read_csv(file.path(data_dir, "am_2017_01_v2_monthly_panel.csv"),          show_col_types = FALSE) |> dplyr::mutate(period_date = as.Date(.data$period_date))
fiscal_panel      <- readr::read_csv(file.path(data_dir, "am_2017_01_v2_bimonthly_fiscal_panel.csv"), show_col_types = FALSE) |> dplyr::mutate(period_date = as.Date(.data$period_date))
...
meta <- tibble::tribble(
  ...
  "labor_market", "Formal labor market",   "monthly",          "sa", "formal_hiring_balance_sa_per_100k_wap",              "Formal hiring SA",
  "labor_market", "Formal labor market",   "monthly",          "sa", "formal_hiring_balance_construction_sa_per_100k_wap", "Construction SA",
  "consumption",  "Household consumption", "monthly",          "sa", "retail_volume_index_sa",                             "Retail SA",
  "consumption",  "Household consumption", "monthly",          "sa", "services_volume_index_sa",                           "Services SA",
