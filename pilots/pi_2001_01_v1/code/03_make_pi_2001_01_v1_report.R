...
report_lines <- c(
  ...
  "## Preliminary plots",
  "",
  figure_link("preliminary_tax_base.png"), "",
  ...
  "",
  figure_link("augmented_paths_tax_base.png"), "",
  figure_link("augmented_gaps_tax_base.png"), "",
  ...
  "## Donor weights",
  "",
  figure_link("donor_weights_tax_base.png"), "",
  ...
  if (has_placebo_inspace) {
    c("Each eligible donor is treated as pseudo-treated at the same dates; gaps are normalized by each unit's pre-treatment RMSPE. The p-value is the share of donor placebos with a post/pre RMSPE ratio (or absolute post gap) at least as large as the treated unit's.",
      ...
      figure_link("placebo_gaps_tax_base.png"), "",
      figure_link("placebo_rmspe_ratio_tax_base.png"), "",
