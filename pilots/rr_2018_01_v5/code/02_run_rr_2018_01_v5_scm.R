...
readr::write_csv(summary, file.path(output_root, "rr_2018_01_v5_scm_summary.csv"), na = "")

message("RR 2018-01 V5 SCM completed.")
message("Saved summary to: ", file.path(output_root, "rr_2018_01_v5_scm_summary.csv"))
