# PB_2009_01 results report (nova estrategia v2, k=6)

Generated on 2026-06-19.

Treated state: `PB`. Removal: `2009-02-17`.
...
| --- | --- | --- | --- | --- |
| Varejo MA6 (log) | 4.04 | 4.04 | 0.01 | 31 |
| ICMS CONFAZ 6m pc (log) | 5.45 | 5.45 | 0.01 | 31 |

### Covariate balance

| Covariate | Treated | Varejo MA6 (log) | ICMS CONFAZ 6m pc (log) |
| --- | --- | --- | --- |
| ICMS secondary VA pc |  7.105 |  6.495 |  5.812 |
| ICMS tertiary VA pc | 19.505 | 20.764 | 23.661 |
| ICMS energy VA pc |  3.180 |  3.440 |  3.695 |
| ICMS fuels VA pc |  4.372 |  6.728 |  7.475 |
| FPE transfer pc | 30.006 | 41.494 | 34.061 |
...
| --- | --- | --- | --- | --- |
| Household consumption | Retail volume, MA6 trailing, log | -0.07 | 0.01 | 23 |
| State public finances | ICMS CONFAZ per capita, 6m sum, log BRL/resident | -0.03 | 0.01 | 23 |
...
| --- | --- | --- | --- | --- |
| Varejo MA6 (log) | -0.06 | -0.07 | -0.05 | -0.01 |
| ICMS CONFAZ 6m pc (log) | -0.03 | -0.03 | -0.03 | -0.04 |
...
| --- | --- | --- |
| Varejo MA6 (log) | 8 / 24 | 0.333333333333333 |
| ICMS CONFAZ 6m pc (log) | 5 / 24 | 0.208333333333333 |
...
| --- | --- | --- | --- |
| Varejo MA6 (log) | -0.006 | 24 / 24 | 0.042 |
| ICMS CONFAZ 6m pc (log) | -0.037 | 24 / 24 | 0.042 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Varejo MA6 (log) | weak | -7.0% | 8/24 | 0.333 | 0.10 | 0.58 | 0.14 | 0.99 | 0.99 |  | 24/24 | 0.042 | 1.00 |
| ICMS CONFAZ 6m pc (log) | weak | -3.2% | 5/24 | 0.208 | 0.45 | 1.00 | 0.01 | 1.00 | 0.99 |  | 24/24 | 0.042 | 1.00 |
