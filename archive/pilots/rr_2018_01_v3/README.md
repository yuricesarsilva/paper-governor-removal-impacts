...
1. `code/01_build_rr_2018_01_v3_panels.R`
   ...
   - Creates V3 moving averages: complete trailing windows in pre-treatment, then expanding trailing windows from the first post-treatment period onward.

2. `code/02_run_rr_2018_01_v3_scm.R`
