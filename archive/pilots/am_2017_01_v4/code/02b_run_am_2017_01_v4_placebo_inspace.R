...
scm_summary    <- readr::read_csv(file.path(output_root, "am_2017_01_v4_scm_summary.csv"),       show_col_types = FALSE)
...
preferred_specs <- tibble::tribble(
  ...
  "formal_hiring_balance_sa_per_100k_wap",                    "bimonthly",  "sa",           "labor_market",   "Formal hiring",
  "formal_hiring_balance_construction_sa_per_100k_wap",       "bimonthly",  "sa",           "labor_market",   "Construction",
  "retail_volume_index_sa",                                   "bimonthly",  "sa",           "consumption",    "Retail",
  "services_volume_index_sa",                                 "bimonthly",  "sa",           "consumption",    "Services",
  "state_tax_revenue_real_pc_sa",                             "bimonthly",  "sa",           "public_sector",  "Own tax revenue",
  "icms_revenue_real_pc_sa",                                  "bimonthly",  "sa",           "public_sector",  "ICMS",
  "public_investment_liquidated_real_pc_sa",                  "bimonthly",  "sa",           "public_sector",  "Public investment",
  "liquidated_expenditure_total_real_pc_sa",                  "bimonthly",  "sa",           "public_sector",  "Total expenditure"
)
