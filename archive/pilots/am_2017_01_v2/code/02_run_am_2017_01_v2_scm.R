...
event <- readr::read_csv(
  file.path(data_dir, "am_2017_01_v2_event_metadata.csv"), show_col_types = FALSE
) |>
  dplyr::slice(1) |>
  dplyr::mutate(
...
covariates <- readr::read_csv(
  file.path(data_dir, "am_2017_01_v2_covariates.csv"), show_col_types = FALSE
)
...
monthly_panel <- readr::read_csv(
  file.path(data_dir, "am_2017_01_v2_monthly_panel.csv"), show_col_types = FALSE
) |> dplyr::mutate(period_date = as.Date(.data$period_date))

fiscal_panel <- readr::read_csv(
  file.path(data_dir, "am_2017_01_v2_bimonthly_fiscal_panel.csv"), show_col_types = FALSE
) |> dplyr::mutate(period_date = as.Date(.data$period_date))
...
readr::write_csv(summary_tbl, file.path(output_root, "am_2017_01_v2_scm_summary.csv"), na = "")
...
message("AM 2017-01 V2 SCM completed.")
message("Saved: ", file.path(output_root, "am_2017_01_v2_scm_summary.csv"))
