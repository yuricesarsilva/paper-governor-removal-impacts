...
V5_segment_moving_average <- function(x, analysis_period, window) {
...
add_V5_moving_average <- function(data, vars, window) {
  data |>
    ...
    dplyr::mutate(
      dplyr::across(
        dplyr::all_of(vars),
        ~V5_segment_moving_average(.x, .data$analysis_period, window),
...
readr::write_csv(monthly_panel, file.path(pilot_data_dir, "rr_2018_01_v5_monthly_panel.csv"), na = "")
readr::write_csv(fiscal_panel, file.path(pilot_data_dir, "rr_2018_01_v5_bimonthly_fiscal_panel.csv"), na = "")
readr::write_csv(quarterly_panel, file.path(pilot_data_dir, "rr_2018_01_v5_quarterly_pnadc_panel.csv"), na = "")
readr::write_csv(covariates, file.path(pilot_data_dir, "rr_2018_01_v5_covariates.csv"), na = "")
readr::write_csv(event_metadata, file.path(pilot_data_dir, "rr_2018_01_v5_event_metadata.csv"), na = "")

message("RR 2018-01 V5 panels built:")
