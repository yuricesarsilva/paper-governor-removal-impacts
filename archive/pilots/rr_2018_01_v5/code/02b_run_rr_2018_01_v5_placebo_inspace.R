...
monthly_panel <- readr::read_csv(
  file.path(data_dir, "rr_2018_01_v5_monthly_panel.csv"), show_col_types = FALSE
) |> dplyr::mutate(period_date = as.Date(.data$period_date))

fiscal_panel <- readr::read_csv(
  file.path(data_dir, "rr_2018_01_v5_bimonthly_fiscal_panel.csv"), show_col_types = FALSE
) |> dplyr::mutate(period_date = as.Date(.data$period_date))

scm_summary <- readr::read_csv(
  file.path(output_root, "rr_2018_01_v5_scm_summary.csv"), show_col_types = FALSE
)
