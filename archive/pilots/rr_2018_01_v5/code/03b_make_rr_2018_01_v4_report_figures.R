...
covariates_raw <- readr::read_csv(
  file.path(data_dir, "rr_2018_01_v5_covariates.csv"),
  show_col_types = FALSE
)
...
monthly_panel <- readr::read_csv(
  file.path(data_dir, "rr_2018_01_v5_monthly_panel.csv"),
  show_col_types = FALSE
) |>
  ...
  ggplot2::ggplot() +
    ...
    ggplot2::labs(
      ...
      subtitle = if (specification_value == "raw") {
        ...
        "V5 smoothing rule: full windows in pre-treatment, expanding windows after the break"
      },
...
save_plot(build_augmented_paths_plot("public_sector", "ma4_V5"), "augmented_paths_public_sector_smooth.png")
...
save_plot(build_augmented_gaps_plot("public_sector", "ma4_V5"), "augmented_gaps_public_sector_smooth.png")
...
save_plot(build_weight_plot("public_sector", "ma4_V5"), "donor_weights_public_sector_smooth.png")

save_plot(effect_summary_plot, "augmented_effect_summary.png", width = 10, height = 6)

message("RR 2018-01 V5 report figures regenerated.")
