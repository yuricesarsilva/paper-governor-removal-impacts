...
The script `code/01_build_rr_2018_01_v2_panels.R` creates:
...
The script `code/02_run_rr_2018_01_v2_scm.R` is configured to estimate Classic SCM and Augmented SCM together for:
...
- Visual moving-average figures use partial windows at the beginning of each pre/crisis/post segment to avoid hiding the immediate transition period.
